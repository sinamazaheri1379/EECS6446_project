...
def execute_apply_hpa_config(config_type):
    ...
    if config_type == 'baseline':
        ...
        subprocess.run([
            "kubectl", "apply", "-f",
            "/home/claude/optimizations/scaling/cartservice-elascale-hpa.yaml"
        ])
        subprocess.run([
            "kubectl", "apply", "-f",
            "/home/claude/optimizations/scaling/services-elascale-hpa.yaml"
        ])
...
def knowledge_store_results(experiment_name, data):
    ...
    filename = f"/home/claude/optimizations/results/{experiment_name}_{timestamp}.csv"
...
def main():
    ...
    print("   jupyter notebook /home/claude/optimizations/analysis/elascale_analysis.ipynb")
    print("\n2. Generate diagrams:")
    print("   python3 /home/claude/optimizations/scripts/generate_diagrams.py")
